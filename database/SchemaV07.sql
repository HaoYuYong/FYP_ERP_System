-- ============================================================================
-- SCHEMA V07 – LINE ITEM SNAPSHOT COMPLETENESS
-- ============================================================================
-- Changes from V06:
--
--   1. purchase_request_item (UPDATED)
--        – Added item_name VARCHAR(255)
--          Snapshot of inventory.item_name frozen at line-creation time.
--          Pre-filled from inventory when item_id is selected, but editable.
--          Separates the item identity (item_name) from the printed description
--          (item_description), so both are independently preserved historically.
--
--   2. purchase_order_item (UPDATED)
--        – Added item_name VARCHAR(255)
--          Same rationale as purchase_request_item above.
--
...
-- Confirm purchase_request_item has item_name column
-- SELECT column_name, data_type, is_nullable
-- FROM information_schema.columns
-- WHERE table_name = 'purchase_request_item' AND table_schema = 'public'
-- ORDER BY ordinal_position;

-- Confirm purchase_order_item has item_name column
-- SELECT column_name, data_type, is_nullable
-- FROM information_schema.columns
-- WHERE table_name = 'purchase_order_item' AND table_schema = 'public'
-- ORDER BY ordinal_position;

-- Confirm purchase_request has supplier snapshot columns
