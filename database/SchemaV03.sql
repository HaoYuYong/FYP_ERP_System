-- ============================================================================
-- SCHEMA V03 – LOG-BASED AUDIT TRACKING (NO created_at/updated_at)
-- ============================================================================
-- This schema removes all created_at and updated_at columns and replaces them
-- with log_id references to a centralized log table. This approach:
--   1. Eliminates data redundancy (timestamps in log table only)
--   2. Provides complete audit trail via log table (INSERT, UPDATE, DELETE)
--   3. Single source of truth for record lifecycle events
-- ============================================================================
