...
// ==============================================
// NEW ICONS FOR FLOATING ACTION MENU
// ==============================================

/**
 * PlusIcon – Used as the main floating action button.
 */
...
/**
 * ItemIcon – Represents adding a new inventory item.
 */
...
/**
 * CIcon – Represents adding a new classification (C stands for Classification).
 */
export const CIcon: React.FC<{ className?: string }> = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
// ==============================================
// NEW ICONS FOR Editing Inventory Items (Used in InventoryPage)
// ==============================================
