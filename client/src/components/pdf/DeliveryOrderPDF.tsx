...
export interface DOPDFCustomer {
  company_name?: string;
...
export interface DOPDFItem {
  item_name: string;
  item_description?: string;
  uom?: string;
  do_quantity: number | string;
  unit_price: number | string;
  line_total: number | string;
}

export interface DeliveryOrderPDFProps {
  doNo: string;
  referenceNo: string;
  deliveryDate: string;
  terms: string;
...
const s = StyleSheet.create({
  ...
  // ═══════════════════════════════════════════════════
  // SECTION 2 — Document title + Customer / DO details
  // ═══════════════════════════════════════════════════
  docTitle: {
    fontSize: 18,
    fontFamily: 'Helvetica-Bold',
...
const DeliveryOrderPDF: React.FC<DeliveryOrderPDFProps> = ({
  doNo,
  referenceNo,
  deliveryDate,
  terms,
  ...
  return (
    <Document title={`Delivery Order ${doNo}`} author={printedBy}>
      <Page size="A4" style={s.page}>
        ...
        <View style={s.pageFooter} fixed>
          <Text style={s.pageFooterText}>{doNo}</Text>
          <Text
        ...
        <View style={s.twoColRow}>
          ...
          {/* ── Right 40%: DO Reference box ── */}
          <View style={s.colRight}>
            <View style={s.refBox}>
              <View style={s.refRow}>
                <Text style={s.refLabel}>DO No.</Text>
                <Text style={s.refValue}>{fmt(doNo)}</Text>
              </View>
              <View style={s.refRow}>
              ...
              <View style={s.refRow}>
                <Text style={s.refLabel}>Delivery Date</Text>
