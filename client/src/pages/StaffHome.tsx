    ...
    <div className="p-6">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">
          Manage daily inventory tasks, process orders, and track stock levels.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          { title: 'Products to Restock', value: '0', color: 'bg-blue-500', icon: '📦' },
          { title: 'Open Orders', value: '0', color: 'bg-yellow-500', icon: '📋' },
          { title: 'Low Stock Items', value: '0', color: 'bg-orange-500', icon: '⚠️' },
          { title: 'Today\'s Sales', value: 'RM 0', color: 'bg-green-500', icon: '💰' },
        ].map((stat) => (
      ...
      <div className="bg-white rounded-lg shadow p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          <button className="bg-primary-600 text-white py-3 px-4 rounded-lg hover:bg-primary-700 transition-colors text-left">
            ...
            <div className="text-sm opacity-90">Fulfill pending orders</div>
          </button>
          <button className="bg-green-600 text-white py-3 px-4 rounded-lg hover:bg-green-700 transition-colors text-left">
            ...
            <div className="text-sm opacity-90">Adjust inventory levels</div>
          </button>
          <button className="bg-purple-600 text-white py-3 px-4 rounded-lg hover:bg-purple-700 transition-colors text-left">
            ...
            <div className="text-sm opacity-90">Quick product lookup</div>
          </button>
        </div>
      </div>
